...
docker-compose ps
docker exec dnsclient01 /bin/sh -c "ping -c 2 dns1.gerard.test"
docker exec dnsclient01 /bin/sh -c "ping -c 2 client01.gerard.test"
docker exec dnsclient01 /bin/sh -c "ping -c 2 client02.gerard.test"
docker exec dnsclient01 /bin/sh -c "dig @72.28.1.100 NS gerard.test"
docker exec dnsclient01 /bin/sh -c "dig @72.28.1.100  client01.gerard.test"
